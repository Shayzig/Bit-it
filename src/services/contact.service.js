...
function getUser() {
    return { name: 'Moshe', coins: 100, moves: [], img: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1160&q=80' }
}
...
function getContacts(filterBy = null) {
    return new Promise((resolve, reject) => {
        ...
        if (filterBy) {
            ...
            contactsToReturn = gContacts.filter(contact => contact.name.toLowerCase().includes(name.toLowerCase()) &&
